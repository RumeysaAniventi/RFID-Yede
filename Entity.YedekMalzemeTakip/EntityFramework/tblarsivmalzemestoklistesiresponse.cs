...
{
    [Persistent("tblarsivmalzemestoklistesiresponse")]
    public class tblarsivmalzemestoklistesiresponse : TabloObject
    {

        public tblarsivmalzemestoklistesiresponse(Session session) : base(session) { }
        ...
        public string degisenalan
        {
            ...
            set { SetPropertyValue<string>("matnr", ref _degisenalan, value); }
        }
