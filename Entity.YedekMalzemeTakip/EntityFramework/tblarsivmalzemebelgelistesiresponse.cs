...
{
    [Persistent("tblarsivmalzemebelgelistesiresponse")]
    public class tblarsivmalzemebelgelistesiresponse : TabloObject
    {
        public tblarsivmalzemebelgelistesiresponse(Session session) : base(session) { }
