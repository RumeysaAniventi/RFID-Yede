...
{
    [Persistent("tblmalzemebelgelistesireturn")]
    public class tblmalzemebelgelistesireturn : TabloObject
    {

        public tblmalzemebelgelistesireturn(Session session) : base(session) { }
