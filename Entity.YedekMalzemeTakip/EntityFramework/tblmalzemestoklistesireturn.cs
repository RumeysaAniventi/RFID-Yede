...
{
    [Persistent("tblmalzemestoklistesireturn")]
    public class tblmalzemestoklistesireturn : TabloObject
    {
        public tblmalzemestoklistesireturn(Session session) : base(session) { }
