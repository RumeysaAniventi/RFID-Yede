<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.Master" AutoEventWireup="true" CodeBehind="koltukdepo.aspx.cs" Inherits="YedekMalzeme.Arayuz.koltukdepo" %>
    ...
    <div class="m-content">
        ...
        <div class="modal fade" data-backdrop="static" id="m_modal_3" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true" style="display: none;">
            <div class="modal-dialog modal-lg" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="exampleModalLabex">RFID Ekli Bileşenler</h5>
                        <img src="resimler/close.png" data-dismiss="modal" class="close" />
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder2" runat="server">
    ...
    <script type="text/javascript" src="javascript/jskoltukdepo.js"></script>
</asp:Content>
