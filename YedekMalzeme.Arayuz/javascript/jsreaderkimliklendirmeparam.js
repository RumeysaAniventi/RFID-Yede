...
function jsBilgiGuncelle() {
    ...
    var v_zReaderIp = $('#txtReaderIP').val();
    var v_zReaderPower = $('#txtReaderPower').val();
    ...
    swal({
        ...
        .then((willDelete) => {
            ...
            if (willDelete) {
                ...
                $.ajax({
                    type: "POST",
                    url: "api/RdrKimliklendirmeParametreKayit",
                    data: JSON.stringify
                        ({
...
function jsListele() {
    ...
    $.ajax({
        type: "POST",
        url: "api/RdrKimliklendirmeParametreDeger",
        data: JSON.stringify
            ({
                zdeger: '1'
            }),
        ...
        success: function (msg) {
            ...
            if (msg.zSonuc == "1") {
                ...
                $('#txtReaderIP').val(msg.zReaderIp);
                $('#txtReaderPower').val(msg.zReaderPower);
...
function fn_DegerleriListele() {
    $.ajax({
        type: "POST",
        url: "api/RdrKimliklendirmeParametreListesi",
        data: JSON.stringify
            ({
                zdeger: '1'
            }),
