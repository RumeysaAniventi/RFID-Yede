...
function js_SarfEt() {
    ...
    swal({
        ...
        title: "UYARI",
        html: true,
        text: "Seçili ürünler sarf(tüketim) için sap sistemine gönderilsin mi?",
        icon: "info",
        dangerMode: true
    })
        .then((willDelete) => {
            if (willDelete) {
                ...
                swal({
                    ...
                    html: true,
                    text: "Sipariş Bileşenleri Başarıyla tüketildi",
                    icon: "success",
                    dangerMode: false
                })
                    .then((willDelete) => {
                        window.location.href = 'koltukdepo.aspx';
                    });
...
function js_Rfid_BilesenGoruntule(v_aufnr) {
    $.ajax({
        type: "POST",
...
function js_Sap_BilesenGoruntule(v_aufnr) {
    $.ajax({
        type: "POST",
                ...
                settings.columnDefs = [
                    {
                        ...
                        <span class="dropdown" style='cursor:pointer !important;'>
                            ...
                            <div class="dropdown-menu dropdown-menu-right">
                                <a class="dropdown-item" href="#" onclick="js_Sap_BilesenGoruntule('`+ full[0] + `');"><i class="la la-edit"></i>Bileşenleri Görüntüle (SAP)</a>
                                <a class="dropdown-item" href="#" onclick="js_Rfid_BilesenGoruntule('`+ full[0] + `');"><i class="la la-edit"></i>Bileşenleri Görüntüle (RFID)</a>
